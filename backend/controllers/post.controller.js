...
export const like = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "like server error" });
  }
};
...
export const comment = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "comment server error" });
  }
};
...
export const saved = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "save server error" });
  }
};
